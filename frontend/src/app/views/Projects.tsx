  ...
  return (
    <div className="w-full">
      ...
      <div className="space-y-16 md:space-y-20 lg:space-y-24">
        ...
        >
          ...
          <div className="order-1 lg:order-2 space-y-4 md:space-y-6">
            ...
            <p className="text-gray-400 text-sm md:text-base leading-relaxed">
              Sistema de planificación empresarial donde administradores
              gestionan empresas, usuarios y beneficios, con métricas para
              evaluar qué beneficios impactan más. Mi rol: desarrollo backend
              (NestJS), frontend y paneles completos. Implementación en Fly.io.
              Estado: demo funcional.
            </p>
            <div className="flex flex-wrap gap-2">
              {["NestJS", "React", "Panel Admin", "Fly.io"].map((tag) => (
                <span
                  key={tag}
            ...
            <div className="flex flex-wrap gap-4 md:gap-6 text-xs md:text-sm font-bold pt-2 md:pt-0">
              <a
                href="https://proposal-template-one.vercel.app/"
        ...
        {/* Proyecto 2: Plataforma de Aprendizaje Python */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-50px" }}
        ...
        >
          ...
          <div className="order-1 lg:order-1 space-y-4 md:space-y-6">
            ...
            <p className="text-gray-400 text-sm md:text-base leading-relaxed">
              Aplicación web educativa para aprender Python con ejercicios y
              práctica. Los usuarios pueden elegir modo de aprendizaje o modo
              práctica. Mi rol: desarrollo backend (NestJS) e implementación.
              Implementación: Render (backend) y Vercel (frontend). Estado: demo
              funcional.
            </p>
            <div className="flex flex-wrap gap-2">
              {["NestJS", "API", "Render", "Vercel"].map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] md:text-xs font-mono border border-white/10 px-2 py-1 text-gray-300 rounded-sm bg-white/5"
                >
            ...
            <div className="flex flex-wrap gap-4 md:gap-6 text-xs md:text-sm font-bold pt-2 md:pt-0">
              <a
                href="https://pyquest-frontend-rose.vercel.app/"
        ...
        {/* Proyecto 3: Space Shooter (comentado) */}
        {false && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}

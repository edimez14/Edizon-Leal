...
import { loadFeaturedProjects } from "./utils/featuredProjects";
...
export default function Home() {
  ...
  const [proyectsData, setProjectsData] = useState(null);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const featuredProjects = await loadFeaturedProjects("en");
        setData(loadedData);
